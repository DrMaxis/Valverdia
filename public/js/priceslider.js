...
(function (t) {
  ...
  }), t.widget, t.ui.keyCode = { BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38 }, t.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());var s = !1;t(document).on("mouseup", function () {
    s = !1;
  ...
  }();var l = t.effects;t.effects.define("blind", "hide", function (e, i) {
  ...
  });var l;t.uiBackCompat !== !1 && (l = t.effects.define("transfer", function (e, i) {
    t(this).transfer(e, i);
  }));
});
